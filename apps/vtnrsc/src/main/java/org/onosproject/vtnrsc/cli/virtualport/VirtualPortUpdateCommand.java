...
public class VirtualPortUpdateCommand extends AbstractShellCommand {
    ...
    @Argument(index = 7, name = "deviceOwner",
            description = "ID of the entity that uses this virtualPort.", required = true,
            multiValued = false)
    ...
    @Argument(index = 9, name = "fixedIp",
            description = " a IP address for the port,Include the IP address and "
