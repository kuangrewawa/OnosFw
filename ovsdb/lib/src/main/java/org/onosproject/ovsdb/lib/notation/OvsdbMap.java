...
/**
 * OvsdbMap is a 2-element JSON array that represents a database map value. The
 * first element of the array must be the string "map", and the second element
 * must be an array of zero or more <pair>s giving the values in the map. All of
 * the <pair>s must have the same key and value types.
 */
