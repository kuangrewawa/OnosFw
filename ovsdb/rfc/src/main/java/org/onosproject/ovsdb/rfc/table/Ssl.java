...
public class Ssl extends AbstractOvsdbTableService {
    ...
    public enum SslColumn {
        CACERT("ca_cert"), EXTERNALIDS("external_ids"),
        BOOTSTRAPCACERT("bootstrap_ca_cert"), CERTIFICATE("certificate"),
